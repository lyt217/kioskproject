...
public class Login_Fr_Hud extends JFrame implements ActionListener {
	...
	public Login_Fr_Hud() {
		...
		setLayout(null);
		// 중앙사이즈조절
		int width = (Toolkit.getDefaultToolkit().getScreenSize().width - 1920) / 2;
		int height = (Toolkit.getDefaultToolkit().getScreenSize().height - 1080 ) / 2;
